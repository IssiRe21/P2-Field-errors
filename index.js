...
var changeColorInputs = function(){

    inputPassword.className = inputPassword.className.replace("danger-color", "");
    inputUsername.className = inputUsername.className.replace("danger-color", "");
    labelUser.className = labelUser.className.replace("red-label", "");
    labelPassword.className = labelPassword.className.replace("red-label", "");
}
